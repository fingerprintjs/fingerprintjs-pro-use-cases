...
import styles from './paymentFraudEventRiskScore.module.scss';
...
export default function Index({ embed }: CustomPageProps) {
  ...
  async function handleSubmit(e) {
    ...
    const response = await fetch('/api/payment-fraud-event-risk-score/place-order', {
      method: 'POST',
  ...
  return (
    <UseCaseWrapper useCase={USE_CASES.paymentFraudEventRiskScore} contentSx={{ maxWidth: 'none' }} embed={embed}>
